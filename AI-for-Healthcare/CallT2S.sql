DECLARE
    ...
    v_plaintext varchar2(32000) :=  :P68_PROMPT;
 ...
 BEGIN
    ...
    file_name := SPEECH_SYNTHESIZESPEECH_UPLOADFILE (v_plaintext,v_voice );
    file_name := 'https://objectstorage.us-phoenix-1.oraclecloud.com/n/tenancyname/b/bucketname/o/Speech/'||file_name; 
